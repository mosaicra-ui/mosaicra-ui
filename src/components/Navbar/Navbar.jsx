...
const Products = () => (
    <div className="flex  flex-row xl:flex-col">
        <div className="flex p-8 px-4 items-center justify-start gap-4">
            <div className="mt-1 xl:mt-0 w-[20rem]">
                <div className="flex flex-col justify-center gap-6 ml-4">
                    ...
                    <li>
                        ...
                        >
                            ...
                            <div className="flex flex-col">
                                <span className="flex gap-2 items-center text-dark/80 dark:text-light/80 group-hover:text-dark dark:group-hover:text-light font-[550] text-sm">Explore LLMs
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="18"
                                        height="18"
                                ...
                                <span className="text-sm text-foreground group-hover:text-dark/90 dark:text-foreground group-hover:dark:text-light/50 block xl:hidden">Advanced AI models for text</span>
                            </div>
                        </Link>
                    </li>
                </div>
        ...
        <div className="flex flex-col border-l xl:border-t p-8 border-light-secondary dark:border-dark-secondary w-[38rem] xl:w-[28rem]">
            <span href="/products" className="group flex-shrink-0 text-xs uppercase font-code mb-4">
    ...
    return (
        ...
        <>
            {/* <main className="flex flex-col items-center">
                <div className='container fixed z-50 bg-light dark:bg-dark text-dark dark:text-light transition-all duration-300 ease-in-out'>

                    <nav className='flex items-center justify-between relative h-16 px-44 mx-auto lg:px-16 xl:px-20 md:px-6 md:hidden'>
                        <div className='flex items-center justify-start'>
                            ...
                            >
                                <span className='flex uppercase text-lg items-center gap-2'>
                                    <Image
                                        src={SERVERX_LOGO}
                                        placeholder='blur'
                            ...
                            <div className='flex items-center gap-4 text-md font-semibold dark:font-[550]'>
                                <DropNavLink href="/products" title="Products" className="" />
                                <DropNavLink href="/developers" title="Developers" className="" />
                                <NavLink href="/docs" title="Docs" className="" />
                                <NavLink href="/articles" title="Articles" className="" />
                            </div>
                        </div>
                        <div className='flex items-center'>
                            ...
                            <Link href="https://github.com/serverx-org/server-x-101" target="_blank" data-size="tiny" className="relative justify-center cursor-pointer items-center space-x-2 text-center font-regular ease-out duration-200 rounded-md outline-none transition-all outline-0 focus-visible:outline-4 focus-visible:outline-offset-1 border hover:bg-foreground/15 dark:hover:bg-foreground/15 shadow-none border-transparent text-xs pr-1 h-[26px] group lg:flex text-dark/90 dark:text-light hover:text-dark dark:hover:text-light mr-1.5">
                            ...
                            <Link data-size="tiny" type="button" className="relative justify-center cursor-pointer items-center space-x-2 text-center font-regular ease-out duration-200 rounded-md outline-none transition-all outline-0 focus-visible:outline-4 focus-visible:outline-offset-1 border text-light dark:text-light hover:text-light dark:hover:text-light bg-[#d73553] hover:bg-primary-light dark:hover:bg-primary-light border-light-secondary hover:border-bord-light dark:border-dark-secondary hover:dark:border-bord-dark focus-visible:outline-light shadow-sm text-xs px-2.5 py-1 h-[26px] lg:block" href="/dashboard">
                                <span className="truncate">Sign in</span>
                            </Link>
                        </div>
                    </nav>
                    <nav className='w-full items-center justify-between relative h-16  border-b border-dark/45 hidden md:flex'>
                        <div className={`${burgerMenuActive ? "h-screen" : "h-0"} z-50 h-16 px-44 mx-auto lg:px-16 xl:px-20 md:px-6  w-full absolute top-0 transition-all duration-500 bg-light dark:bg-dark`}>
                            <div className=" top-0 w-full flex items-center justify-between py-4">
                                <Link
                                    href="/"
                                    className='pr-10  font-bold text-lg'
                                >
                                    <span className='flex uppercase text-base items-center gap-2'>
                                        <Image
                                            src={SERVERX_LOGO}
                                            placeholder='blur'
                                            blurDataURL={`${SERVERX_LOGO}`}
                                            ...
                                            alt="serverx-logo"
                                        />
                                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-dark to-primary-light flex flex-shrink-0 overflow-hidden" onClick={toggleBurgerMenu}>server x</span>
                                    </span>
                                </Link>
                                <div className="relative w-8 flex items-center justify-center h-8 !gap-0 cursor-pointer hover:dark:bg-dark-primary/50 hover:bg-light-primary rounded-md transition-all duration-300 ease-in-out" onClick={toggleBurgerMenu}>
                                    <div className={`absolute w-5 h-[2px] bg-light-text dark:bg-dark-text transition-all rounded-full duration-500 ${burgerMenuActive ? 'transform rotate-45 translate-y-4.5 opacity-0' : 'transform -translate-y-[5px]'}`}></div>
                                    <div className={`absolute w-5 h-[2px] bg-light-text dark:bg-dark-text transition-all rounded-full duration-500 ${burgerMenuActive ? 'transform rotate-45 translate-y-4.5 ' : ''}`}></div>
                                    <div className={`absolute w-5 h-[2px] bg-light-text dark:bg-dark-text transition-all rounded-full duration-500 ${burgerMenuActive ? 'transform -rotate-45 -translate-y-4.5' : 'transform translate-y-[5px]'}`}></div>
                                </div>
                            </div>
                ...
                <div className='z-50 border-b border-light-secondary dark:border-dark-secondary top-[4rem] w-full fixed transition-all duration-300 ease-in-out ' />
            </main> */}
            ...
            <div className="sticky top-0 z-40 transform" style={{ transform: 'translate3d(0,0,999px)' }}>
                ...
                <nav className="relative z-40 border-light-secondary dark:border-dark-secondary border-b backdrop-blur-sm transition-all duration-300 ease-in-out">
                    <div className="relative flex justify-between h-16 mx-auto container lg:!px-6 xl:px-20 px-20">
                        <div className="flex items-center lg:px-0 flex-1 sm:items-stretch justify-between">
                            <div className="flex items-center">
                                <div className="flex items-center flex-shrink-0">
                                    <Link href="/" passHref>
                                        <span className="flex  items-center justify-center gap-2 mr-[16px] w-auto h-6 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-gray-600 focus-visible:ring-offset-4 focus-visible:ring-offset-background-alternative focus-visible:rounded-sm" type="button" id="radix-:R1amcq6:" aria-haspopup="menu" aria-expanded="false" data-state="closed">
                                            <Image
                                                src={SERVERX_LOGO}
                                                placeholder='blur'
                                                blurDataURL={`${SERVERX_LOGO}`}
                                                ...
                                                alt="serverx-logo"
                                            />
                                            <span className="text-transparent text-lg bg-clip-text bg-gradient-to-r from-primary-dark to-primary-light font-bold">SERVER X</span>
                                        </span>
                                    </Link>
                                </div>
                        ...
                        <div className="inset-y-0 hidden  items-center  lg:flex">
