...
<img 
  src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/PyTorch_logo_icon.svg/24px-PyTorch_logo_icon.svg.png"
  className="!m-0 w-6 h-6 mt-4"
/>
<h3 className="border-b-2 dark:border-light border-dark w-fit border-dashed uppercase !m-0 font-extrabold">PyTorch</h3>
</div>
...
<div className="flex items-center gap-2">
<img 
  src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Scikit_learn_logo_small.svg/24px-Scikit_learn_logo_small.svg.png"
  className="!m-0 w-6 h-3 mt-4"
/>
<h3 className="border-b-2 dark:border-light border-dark w-fit border-dashed uppercase !m-0 font-extrabold">Scikit-learn</h3>
</div>
...
<div className="flex items-center gap-2">
<img 
  src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Tensorflow_logo.svg/24px-Tensorflow_logo.svg.png"
  className="!m-0 w-6 h-3 mt-4"
/>
<h3 className="border-b-2 dark:border-light border-dark w-fit border-dashed uppercase !m-0 font-extrabold">TensorFlow</h3>
</div>
...
<div className="flex items-center gap-2">
<img 
  src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Apache_Spark_logo.svg/24px-Apache_Spark_logo.svg.png"
  className="!m-0 w-6 h-3 mt-4"
/>
<h3 className="border-b-2 dark:border-light border-dark w-fit border-dashed uppercase !m-0 font-extrabold">Apache Spark MLlib</h3>
</div>
...
<div className="flex items-center gap-2">
<img 
  src="https://avatars.githubusercontent.com/u/1402695?s=24&v=4"
  className="!m-0 w-6 h-6 mt-4"
/>
<h3 className="border-b-2 dark:border-light border-dark w-fit border-dashed uppercase !m-0 font-extrabold">H2O.ai</h3>
</div>
...
<div className="flex items-center gap-2">
<img 
  src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Keras_logo.svg/24px-Keras_logo.svg.png"
  className="!m-0 w-7 h-7 mt-4"
/>
<h3 className="border-b-2 dark:border-light border-dark w-fit border-dashed uppercase !m-0 font-extrabold">Keras</h3>
</div>
...
<div className="flex items-center gap-2">
<img 
  src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/XGBoost_logo.png/24px-XGBoost_logo.png"
  className="!m-0 w-7 h-7 mt-4"
/>
<h3 className="border-b-2 dark:border-light border-dark w-fit border-dashed uppercase !m-0 font-extrabold">XGBoost</h3>
</div>
...
<div className="flex items-center gap-2">
<img 
  src="https://avatars.githubusercontent.com/u/29043415?s=24&v=4"
  className="!m-0 w-7 h-7 mt-4"
/>
<h3 className="border-b-2 dark:border-light border-dark w-fit border-dashed uppercase !m-0 font-extrabold">CatBoost</h3>
</div>
